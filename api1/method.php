...
$conexion->close();
    ...
    case 'POST':
      if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $sql = "INSERT INTO usuarios (id, Nombre, Correo, contrasena ) VALUES ('$Id', '$Nombre','$Correo', '$Contrasena')"; // Reemplaza con el nombre de tu tabla
      ...
      case 'PATCH':
        if ($_SERVER['REQUEST_METHOD'] === 'PATCH') {
          ...
          if ($_SERVER['REQUEST_METHOD'] === 'PATCH') { // Método PATCH
              ...
              $sql = "UPDATE usuarios SET $actualizaciones_str WHERE id = $Id";
          }
    ...
    case 'PUT':
        ...
        if (isset($datos['id']) && isset($datos['Nombre']) && isset($datos['Correo']) && isset($datos['contrasena'])) {
            ...
            $sql = "INSERT INTO usuarios (id, Nombre, Correo, contrasena) VALUES (?, ?, ?, ?)";
